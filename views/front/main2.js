	...
	*/
	$("body").delegate(".category","click",function(event){
		...
		var cid = $(this).attr('cid');
			...
			$.ajax({
url	:	"../../core/action.php",			method	:	"POST",
...
url	:	"../../core/action.php",			method : "POST",
	...
	*/
	$("body").delegate(".update","click",function(event){
		...
		$.ajax({
			url	:	"../../core/action.php",			method	:	"POST",
			data	:	{updatewishlistItem:1,update_id:update_id,qty:qty},
			success	:	function(data){
				$("#cart_msg").html(data);
				wishlistdet();
			}
...
url	:	"../../core/action.php",			method : "POST",
	...
	wishlistdet();
	net_total();
	function wishlistdet(){
		$('.overlay').show();
		   $.ajax({
url	:	"../../core/action.php",			   method : "POST",
			   data : {wishs:1,wishlistdet:1},
			   success : function(data){
				   $('.overlay').hide();
				   $("#wishlist").html(data);
					   net_total();
